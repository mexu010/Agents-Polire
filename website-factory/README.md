...
Der Schnelllauf verarbeitet bis zu **100 unterschiedliche Firmen**. Sechs parallele HTML-Prüfungen lesen je höchstens zwei Seiten ohne Modellaufruf. Die Vollreviews kombinieren auffällige Websites, unklare Fälle und eine Zufallsstichprobe der Websites ohne statische Hinweise. Bei sechs freien Plätzen und ausreichend Fällen je Gruppe sind das drei auffällige, zwei unklare und eine zufällig gezogene Website. Fehlt eine Gruppe, füllen andere offene Firmen die freien Plätze. Höchstens zwei Vollreviews laufen gleichzeitig.

Die Sortierpriorität ist **kein Qualitäts- oder Opportunity-Score**. Fehlende Tags und alte Frames liefern Hinweise, keine fertige Designbewertung. Unklare/gesperrte Seiten, Abruffehler und sehr wenig lesbarer Inhalt erhalten eine Chance auf ein Vollreview. «Kein Signal» bedeutet weiterhin «unbewertet». Der HTML-Filter verwirft keine Firma automatisch; auch noch nicht ausgewählte Firmen erscheinen im Bericht. Aus fehlenden Quellen wird weder eine Geschäftsschliessung noch gute Website-Qualität abgeleitet.
...
Mit `--plan-only` wird die HTML-Vorprüfung ausgeführt bzw. wiederverwendet und die konkrete Auswahl gespeichert, ohne Agent-Reviews zu starten. Zum Ausführen denselben Befehl ohne `--plan-only` wiederholen. Zufallsstartwert, Grundgesamtheit, ausgewählte URLs und Auswahlgrund bleiben gespeichert; Wiederaufnahme zieht keine bequemere Stichprobe. Alle Auswahlplätze, bestehende Versuche und Stichproben zählen innerhalb von `--max-reviews`. Alte Stapel behalten erfolgreiche Reviews und ursprüngliche Grenzen; die neue Auswahl kann nur noch freie Plätze belegen. Bei kleinen oder bereits teilweise verbrauchten Grenzen sind nicht zwingend alle drei Gruppen vertreten.
...
Die Kontrollstichprobe startet zuerst. Der Bericht trennt geplante, abgeschlossene und auswertbare Stichproben von zusätzlichen Review-Kandidaten. Fehlende Scores und fehlgeschlagene Reviews zählen nicht als gute Websites. Ein Treffer zeigt eine von den statischen Merkmalen übersehene mögliche Chance; die kleine Stichprobe wird nicht auf alle Firmen hochgerechnet und bestätigt keine Filtergüte. Eine belastbare Bewertung braucht mehr abgeschlossene Fälle und menschliche Prüfung. Zusätzliche nach einer späteren Quellen-Neuauswertung aufgenommene Firmen ausserhalb der gespeicherten Grundgesamtheit werden separat als Nachprüfung gekennzeichnet.

Der erste [echte Kontrolllauf](reports/selection-control-2026-09-21/README.md) nutzte die zwei verbliebenen Plätze des bestehenden 100er-Stapels. Beide Agent-Läufe waren wegen fehlender Quellen bzw. Bilder nicht vollständig auswertbar. Die Auswahländerung ist getestet; eine bessere Trefferquote ist damit noch nicht belegt.

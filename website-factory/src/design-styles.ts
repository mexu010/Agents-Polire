...
export const designProfileCss = `
.profile-editorial-spread{--profile-rule:1px}.profile-service-index{--profile-rule:2px}.profile-type-poster{--profile-rule:0}
html.spacing-compact{--profile-section-block:clamp(2.5rem,5vw,5rem)}html.spacing-comfortable{--profile-section-block:clamp(3.5rem,7vw,7rem)}html.spacing-generous{--profile-section-block:clamp(4.5rem,9vw,9rem)}
.profile-section{padding:clamp(3.5rem,7vw,7rem) clamp(1.25rem,6vw,7rem);border-top:1px solid var(--line);overflow:hidden}.site-header{container-type:inline-size}.profile-section article,.spread-title,.spread-section-heading,.index-hero>div,.index-section-heading,.poster-title,.poster-section-heading{container-type:inline-size}
.profile-section h1,.profile-section h2,.profile-section h3{font-family:var(--display-font);overflow-wrap:anywhere;hyphens:auto}.profile-section .title-long-word,.profile-section .title-medium-word,.site-header .brand.title-long-word,.site-header .brand.title-medium-word{overflow-wrap:normal;word-break:normal;hyphens:manual}.profile-section h1.title-long-word,.profile-section h2.title-long-word{font-size:clamp(1.7rem,7.5cqw,7rem)}.profile-section h1.title-medium-word,.profile-section h2.title-medium-word{font-size:clamp(2rem,10cqw,8rem)}.profile-section h3.title-long-word{font-size:clamp(1rem,4.5cqw,2rem)}.profile-section h3.title-medium-word{font-size:clamp(1rem,5.5cqw,2rem)}.site-header .brand.title-long-word{font-size:clamp(.85rem,2.8cqw,1.35rem)}.site-header .brand.title-medium-word{font-size:clamp(.95rem,3.2cqw,1.45rem)}.profile-section h1,.profile-section h2{margin:0;letter-spacing:-.06em;line-height:.92}.profile-section h1{font-size:clamp(3.8rem,9vw,9rem)}.profile-section h2{font-size:clamp(2.5rem,5vw,5.5rem)}.profile-section h3{margin:0;line-height:1.05}.profile-body{font-size:clamp(1rem,1.35vw,1.25rem);line-height:1.55}.profile-image{margin:0;overflow:hidden}.profile-image img{display:block;width:100%;height:100%;object-fit:cover}.profile-section .contacts{margin-top:2rem}.profile-section .contact{border-radius:0;background:transparent;border-width:0 0 1px;padding:1rem 0}
.profile-editorial-spread.profile-section.is-hero:not(:has(.profile-image)){padding-top:clamp(2.5rem,4vw,4rem);padding-bottom:clamp(2.5rem,4vw,4rem)}.spread-hero{max-width:1500px;margin:auto;display:grid;grid-template-columns:minmax(0,1.35fr) minmax(260px,.65fr);gap:clamp(1.5rem,4vw,5rem);align-items:end}.spread-title{grid-column:1/-1;max-width:1200px}.spread-title h1{font-weight:400}.spread-detail{max-width:520px;grid-column:2}.spread-hero>.profile-image{grid-column:1;grid-row:2;aspect-ratio:16/9}.spread-section{max-width:1400px;margin:auto;display:grid;grid-template-columns:minmax(220px,.7fr) minmax(0,1.3fr);gap:clamp(2rem,7vw,9rem);align-items:start}.spread-section-heading h2{font-weight:400}.spread-section-content{max-width:760px}.spread-section>.profile-image{grid-column:1/-1;margin-top:2rem;aspect-ratio:16/7}.spread-services{margin-top:2.5rem;border-top:1px solid var(--line)}.spread-services article{display:grid;grid-template-columns:3rem minmax(130px,.6fr) minmax(0,1fr);gap:1rem;padding:1.35rem 0;border-bottom:1px solid var(--line)}.spread-services article.has-long-title{grid-template-columns:3rem minmax(0,1fr)}.spread-services article.has-long-title p{grid-column:2}.spread-services article>span{color:var(--accent);font:800 .75rem ui-sans-serif,system-ui,sans-serif}.spread-services article p{margin:0;color:var(--muted)}
.profile-service-index.profile-section{padding-top:clamp(2.25rem,4vw,4.5rem);padding-bottom:clamp(2.25rem,4vw,4.5rem)}.index-hero{max-width:1200px;margin:auto;display:grid;grid-template-columns:12rem minmax(0,1fr);gap:clamp(2rem,5vw,6rem)}.index-cue{padding-top:.6rem;font-size:.75rem;font-weight:800;letter-spacing:.12em;text-transform:uppercase}.index-hero h1{font-size:clamp(3.2rem,7vw,7rem);font-weight:550}.index-hero .profile-body{max-width:620px;margin-top:2rem}.index-hero>.profile-image{grid-column:2;aspect-ratio:16/7;margin-top:2rem}.index-section{max-width:1200px;margin:auto;display:grid;grid-template-columns:minmax(180px,.5fr) minmax(0,1.5fr);gap:clamp(2rem,5vw,6rem)}.index-section-heading h2{font-size:clamp(1.4rem,2.5vw,2.5rem);letter-spacing:-.035em}.index-section>.profile-image{grid-column:2;max-width:720px;aspect-ratio:3/2;margin-top:1.5rem}.index-services{border-top:2px solid var(--ink);margin-top:2rem}.index-services article{display:grid;grid-template-columns:3rem minmax(130px,.7fr) minmax(0,1.3fr);gap:1rem;padding:1rem 0;border-bottom:1px solid var(--line);align-items:baseline}.index-services article.has-long-title{grid-template-columns:3rem minmax(0,1fr)}.index-services article.has-long-title p{grid-column:2}.index-services article span{font-variant-numeric:tabular-nums;font-size:.75rem}.index-services article p{margin:0;color:var(--muted)}
.profile-type-poster.profile-section{padding-top:clamp(3rem,6vw,6rem);padding-bottom:clamp(3rem,6vw,6rem)}.profile-type-poster.profile-section:nth-of-type(even){background:var(--accent);color:var(--accent-ink)}.poster-hero{max-width:1500px;margin:auto;display:grid;grid-template-columns:minmax(0,1.45fr) minmax(260px,.55fr);gap:clamp(2rem,5vw,6rem);align-items:end}.poster-title h1{text-transform:uppercase;font-weight:900;font-size:clamp(4rem,11vw,11rem);line-height:.78;letter-spacing:-.075em}.poster-detail{padding-bottom:.5rem;font-weight:600}.poster-hero>.profile-image{grid-column:1/-1;aspect-ratio:21/7;margin-top:1rem}.poster-section{max-width:1450px;margin:auto;display:grid;grid-template-columns:minmax(0,1fr) minmax(280px,.65fr);gap:clamp(2rem,5vw,6rem);align-items:start}.poster-section-heading h2{text-transform:uppercase;font-weight:900;line-height:.82}.poster-section>.profile-image{grid-column:1/-1;aspect-ratio:21/8}.poster-services{display:grid;gap:.55rem;margin-top:2rem}.poster-services article{padding:1.25rem;background:var(--ink);color:var(--paper);display:grid;grid-template-columns:3rem 1fr;column-gap:1rem}.poster-services article:nth-child(even){background:var(--accent);color:var(--accent-ink)}.poster-services article span{grid-row:1/3;font-size:.75rem;font-weight:900}.poster-services article h3{text-transform:uppercase;font-size:clamp(1.5rem,3vw,3rem)}.poster-services article p{margin:.3rem 0 0}
.poster-title h1.title-medium-word,.poster-title h1.title-long-word{line-height:1}
.profile-editorial-spread.profile-section{padding-block:var(--profile-section-block)}.profile-editorial-spread.profile-section.is-hero:not(:has(.profile-image)){padding-block:calc(var(--profile-section-block)*.6)}.profile-service-index.profile-section{padding-block:calc(var(--profile-section-block)*.67)}.profile-type-poster.profile-section{padding-block:calc(var(--profile-section-block)*.86)}
@media(max-width:760px){.profile-section{padding:3.5rem 1.25rem}.profile-section h1{font-size:clamp(3rem,15vw,5rem)}.profile-section h1.title-long-word,.profile-section h2.title-long-word{font-size:clamp(1.7rem,7.5cqw,7rem)}.profile-section h1.title-medium-word,.profile-section h2.title-medium-word{font-size:clamp(2rem,10cqw,8rem)}.spread-hero,.spread-section,.index-hero,.index-section,.poster-hero,.poster-section{grid-template-columns:1fr;gap:1.5rem}.spread-title,.spread-detail,.spread-hero>.profile-image,.spread-section>.profile-image,.index-hero>.profile-image,.index-section>.profile-image,.poster-hero>.profile-image,.poster-section>.profile-image{grid-column:1;grid-row:auto}.spread-detail{max-width:none}.spread-hero>.profile-image{aspect-ratio:4/3}.spread-services article,.index-services article{grid-template-columns:2.5rem 1fr}.spread-services article p,.index-services article p{grid-column:2}.index-cue{order:-1}.index-hero>.profile-image{order:2;aspect-ratio:4/3}.poster-title h1{font-size:clamp(3.7rem,18vw,6rem)}.poster-title h1.title-long-word{font-size:clamp(1.7rem,7.5cqw,7rem)}.poster-title h1.title-medium-word{font-size:clamp(2rem,10cqw,8rem)}.poster-detail{max-width:32rem}.poster-hero>.profile-image{aspect-ratio:4/3}.poster-services article{grid-template-columns:2.5rem 1fr}}
`.trim();
